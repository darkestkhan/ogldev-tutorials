...
package body Util is
  ...
  procedure Update
  is
    Camera_Pos    : constant GL.Floats_3 := (0.0, 0.0, -3.0);
    Camera_Target : constant GL.Floats_3 := (0.0, 0.0,  2.0);
    Camera_Up     : constant GL.Floats_3 := (0.0, 1.0, 0.0);
  begin
    Scale := Scale + 0.1;
  ...
  is
    ...
    Dir           : constant String := "src/tut13/shaders/";
    Success       : Boolean := False;
